      ...
      <div className="p-4 bg-white shadow-md rounded-lg mb-4">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Select
            ...
            onSelectionChange={setApartmentType}
            label={
              <span
                style={{
                  color: "#1a1a1a",
        ...
        <div className="relative w-full sm:w-[calc(50%-8px)] md:w-[calc(33.33%-8px)] lg:w-[150px]">
          ...
          {openSlider && (
            <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-md w-[300px] z-10">
        ...
        <div className="w-full md:w-1/2 h-[50vh] md:h-auto">
          <LoadScript googleMapsApiKey="AIzaSyD_e9oLPJPgTHLfcua98DZXFmHt_r2lMOI">
            ...
            >
              ...
              <Polygon
                paths={searchResults.map((property) => ({
              ...
              {searchResults.map((property, index) => (
                <Circle
                  key={property.id}
                  center={{ lat: property.property_latitude, lng: property.property_longitude }}
              ...
              {searchResults.map((property, index) => (
                <Marker
                  key={property.id}
                  position={{ lat: property.property_latitude, lng: property.property_longitude }}
                  onClick={() => handleMarkerClick(property)}
                >
